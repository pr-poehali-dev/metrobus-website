    ...
    <section id="how-it-works" className="scroll-mt-20">
      ...
      <div className="mt-3 space-y-3">
        {[
          ...
          { n: 2, title: 'Используйте цифровой сервис ICQR', text: 'Результат - трасса маршрута для этого транспорта и кнопка "Оценить".' },
          { n: 3, title: 'Проверьте данные и поставьте оценку', text: 'Удобство маршрута желательно оценивать отдельно от комфорта поездки.' },
        ].map((s) => (
