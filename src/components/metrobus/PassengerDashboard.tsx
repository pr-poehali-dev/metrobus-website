    ...
    <section id="dashboard" className="scroll-mt-20">
      ...
      {dataScope === 'mine' && !hasMyToken && (
        <div className="mt-4 flex items-center gap-2 rounded-lg border border-amber-500/30 bg-amber-500/10 px-4 py-3 text-sm">
          ...
          <span>Этот браузер ещё не связан с вашей активностью. Используйте кнопку на карте ICQR.RU для перехода на этот дашборд — после этого ваши оценки и место в рейтинге будут отображаться здесь автоматически.</span>
        </div>
      )}
