      ...
      <main id="top" className="mx-auto max-w-5xl px-4">
        ...
        <section className="pt-10 pb-8 sm:pt-16 sm:pb-12">
          ...
          <h1 className="text-3xl font-bold leading-tight sm:text-5xl">
            Оценивай свои поездки.<br />Без приложения. Без регистрации.
          </h1>
            ...
            <section>
              <div className="grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  { icon: 'UserX', title: 'Не переживай', text: 'Не нужны аккаунты и пароли. Сообщаешь свое мнение анонимно.' },
        ...
        <div className="mx-auto max-w-5xl px-4 py-10">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-md text-sm text-muted-foreground">Цифровые сервисы пассажира</p>
            </div>
