      ...
      <Dialog open={cityDialogOpen} onOpenChange={setCityDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="pt-2 text-left text-foreground">
              Запустить сервис в другом городе или регионе технически несложно — способ оценки
              универсален, а технология — проверена, но требуется согласие властей или желание
              местных перевозчиков.
              <br />
              <br />
              Оставьте заявку — так мы поймём, где сервис нужнее всего.
            </DialogDescription>
          </DialogHeader>
          <CityRequestForm />
        </DialogContent>
