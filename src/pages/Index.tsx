            ...
            <section>
              <div className="grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  { icon: 'Megaphone', title: 'Эффективно', text: 'Ваши оценки увидят и перевозчики, и организатор перевозок. Найти их можно будет позже — в этом браузере они не потеряются.' },
                ].map((b) => (
