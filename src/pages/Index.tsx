      ...
      <main id="top" className="mx-auto max-w-5xl px-4">
        ...
        <section className="pt-10 pb-8 sm:pt-16 sm:pb-12">
          ...
          <p className="mt-4 max-w-xl text-base text-muted-foreground sm:text-lg">
            Автобус, трамвай, троллейбус. Твоя оценка попадает к перевозчикам и городу — и меняет транспорт к лучшему.
          </p>
        ...
        <Tabs defaultValue="passengers" className="pb-16">
            ...
            <section>
              ...
              <div className="mt-6 space-y-3">
                {[
                  ...
                  { n: 2, icon: 'Map', title: 'Вводишь его в QR-поиск на ICQR.RU', text: 'Получаешь карту маршрута и точную остановку.' },
          ...
          <TabsContent value="carrier" className="mt-8">
            <RoleSection
              icon="Building2"
              title="Для перевозчиков"
              value="Видьте обратную связь пассажиров в реальном времени — по видам транспорта и дням, без ручного сбора жалоб. Работайте на опережение и повышайте оценку парка."
              bullets={[
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-md text-sm text-muted-foreground">
                Сервис оценки поездок на наземном транспорте Санкт-Петербурга.
              </p>
            </div>
