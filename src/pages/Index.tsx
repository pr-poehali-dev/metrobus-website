          ...
          <TabsContent value="passengers" className="mt-8 space-y-16">
            ...
            <section>
              <div className="grid gap-4 sm:grid-cols-3">
                {[
                  { icon: 'Timer', title: 'Новый способ', text: 'Ввели короткий номер с борта — поставили оценку. Пассажир ли вы или наблюдатель — способ один и тот же.' },
                  { icon: 'UserX', title: 'Не переживай', text: 'Никто не узнает, кто вы. Пишите прямо — честная оценка помогает городу.' },
                  { icon: 'Megaphone', title: 'Твой голос услышат', text: 'Ваши оценки увидят и перевозчики, и организатор перевозок. Найти их можно будет позже — в этом браузере они не потеряются.' },
                ].map((b) => (
